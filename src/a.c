        ...
        { // impressao nome da marca com 2 linhas
            ...
            if (posicao_nome == 17)
            {
                ...
                { // impressao do fabricante com 2 linhas
                    ...
                    {
                        printf("| ");
                        printf("%d",fabricante[i].telefone); //!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
void EstruturaTabela(FABRICANTE *fabricante, int marca_registrada)
{
    ...
    // nome__site_compactado(fabricante, marca_registrada);
    int v=0,p=1;
    printf("\n%d\n",(*(fabricante+v)).telefone);
    printf("\n%d\n",(*(fabricante+p)).telefone);
}